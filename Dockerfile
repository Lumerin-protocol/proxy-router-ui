...
ARG REACT_APP_BUY_LMR_URL
ENV REACT_APP_BUY_LMR_URL=$REACT_APP_BUY_LMR_URL
...
ARG REACT_APP_USDC_TOKEN_ADDRESS
ENV REACT_APP_USDC_TOKEN_ADDRESS=$REACT_APP_USDC_TOKEN_ADDRESS
...
ARG REACT_APP_VALIDATOR_REGISTRY_ADDRESS
ENV REACT_APP_VALIDATOR_REGISTRY_ADDRESS=$REACT_APP_VALIDATOR_REGISTRY_ADDRESS
ARG REACT_APP_WALLET_CONNECT_ID
