...
export const getWeb3ResultAsync: (
  ...
  try {
    ...
    if (provider) {
      ...
      //const deployedNetwork = {address: '0x702B0b76235b1DAc489094184B7790cAA9A39Aa4'}; //prod-beta 7/14/2022 - ABS
      //const deployedNetwork = {address: '0x1F96Ac8f1a030aa0619ab9e203b37a7c942EEFe8'}; //Dev-stg-2nd time testing 7/14/2022 -ABS
      //const deployedNetwork = {address: '0x8C9C79Da3bbE8E1499a27cF56746Bb12cA83a2b9'}; //main 8/1/2022 -ABS
        const deployedNetwork = {address: '0x702B0b76235b1DAc489094184B7790cAA9A39Aa4'}; //old main 8/1/2022 -ABS
