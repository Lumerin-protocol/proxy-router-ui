...
export const getWeb3ResultAsync: (
  ...
  try {
    ...
    if (provider) {
      ...
      const deployedNetwork = {address: '0x1F96Ac8f1a030aa0619ab9e203b37a7c942EEFe8'}; //DEV 8/8/2022 -ABS
      //const deployedNetwork = {address: '0x702B0b76235b1DAc489094184B7790cAA9A39Aa4'}; //STG 8/8/2022 -ABS
      //const deployedNetwork = {address: '0x8C9C79Da3bbE8E1499a27cF56746Bb12cA83a2b9'}; //MAIN 8/8/2022 -ABS
