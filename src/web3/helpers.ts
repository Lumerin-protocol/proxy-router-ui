...
export const getWeb3ResultAsync: (
	...
	try {
		...
		if (provider) {
			...
			const deployedNetwork = { address: process.env.REACT_APP_CLONE_FACTORY }; //DEV GORLI 9/26/22 v2 - JK
			...
			const deployedNetwork = { address: '0xa963e1DC7F5AdC825f93C2aA0aF497522Fe7A9E8' }; //STG GORLI 9/26/22 v2 - JK
