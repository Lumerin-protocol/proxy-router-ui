...
import { CloseOutType, ContentState, ContractState, HashRentalContract } from "../../../types/types";
import { isNoClaim, printError } from "../../../utils/utils";
...
export const ClaimLmrForm: React.FC<ClaimLmrFormProps> = ({ contractId, web3Gateway, closeForm }) => {
